 ...
 * @LastEditors: congz
 * @LastEditTime: 2020-10-27 14:03:24
 */
package wrappers
...
//otherWrapper go-micro Wrapper其他服务中间件
type otherWrapper struct {
	client.Client
}

//Call Wrapper中间件的执行方法
func (wrapper *otherWrapper) Call(ctx context.Context, req client.Request, rsp interface{}, opts ...client.CallOption) error {
...
//NewOtherWrapper 初始化Wrapper
func NewOtherWrapper(c client.Client) client.Client {
	return &otherWrapper{c}
}
